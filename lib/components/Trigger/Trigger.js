...
var Trigger = _react2.default.createClass({
  ...
  componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
    ...
    if (this.popupRendered) {
      var _ret = function () {
        var self = _this;
        _react2.default.unstable_renderSubtreeIntoContainer(_this, _this.getPopupElement(), _this.getPopupContainer(), function renderPopup() {
  ...
  componentWillUnmount: function componentWillUnmount() {
    ...
    if (popupContainer) {
      _react2.default.unmountComponentAtNode(popupContainer);
  ...
  onDocumentClick: function onDocumentClick(event) {
    ...
    var root = (0, _react.findDOMNode)(this);
  ...
  getPopupContainer: function getPopupContainer() {
    if (!this.popupContainer) {
      ...
      var mountNode = this.props.getPopupContainer ? this.props.getPopupContainer((0, _react.findDOMNode)(this)) : document.body;
